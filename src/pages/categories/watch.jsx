...
class WatchCat extends React.Component {
        ...
        return (
            <div style={{width:'100%'}}>
                ...
                <div className='ForReducingMargin' style={{ marginLeft: '150px', marginRight: '150px', marginTop: '170px' }}>
                    <p style={{ color: 'grey', marginLeft: '20px', fontSize: '13px' }}>Home / watch</p>
                    <h3 style={{ fontWeight: '700' }}>Watches In Pakistan</h3>
                    <hr />
                    <div className="fullForCat">
                        {this.props.cards.map((card, key) =>
                        card.category === 'Watches' ?
...
export default connect(mapStateToProps, mapDispatchToProp)(WatchCat);