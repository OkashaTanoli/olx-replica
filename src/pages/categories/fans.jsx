...
class FansCat extends React.Component {
        ...
        return (
            <div>
                ...
                <div className='ForReducingMargin' style={{ marginLeft: '150px', marginRight: '150px', marginTop: '170px' }}>
                    <p style={{ color: 'grey', marginLeft: '20px', fontSize: '13px' }}>Home / Fans</p>
                    <h3 style={{ fontWeight: '700' }}>Fans In Pakistan</h3>
                    <hr />
...
export default connect(mapStateToProps, mapDispatchToProp)(FansCat);