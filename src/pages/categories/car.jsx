...
class CarsCat extends React.Component {
        ...
        return (
            <div>
                ...
                <div className='ForReducingMargin' style={{ marginLeft: '150px', marginRight: '150px', marginTop: '170px' }}>
                    <p style={{ color: 'grey', marginLeft: '20px', fontSize: '13px' }}>Home / Cars</p>
                    <h3 style={{ fontWeight: '700' }}>Cars In Pakistan</h3>
                    <hr />
...
export default connect(mapStateToProps, mapDispatchToProp)(CarsCat);