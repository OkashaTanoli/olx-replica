...
class MobileCat extends React.Component {
        ...
        return (
            <div>
                ...
                <div className='ForReducingMargin' style={{ marginLeft: '150px', marginRight: '150px', marginTop: '170px' }}>
                    <p style={{ color: 'grey', marginLeft: '20px', fontSize: '13px' }}>Home / Mobile Phone</p>
                    <h3 style={{ fontWeight: '700' }}>Mobile Phone In Pakistan</h3>
                    <hr />
...
export default connect(mapStateToProps, mapDispatchToProp)(MobileCat);