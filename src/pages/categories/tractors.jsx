...
class TractorsCat extends React.Component {
        ...
        return (
            <div>
                ...
                <div className='ForReducingMargin' style={{ marginLeft: '150px', marginRight: '150px', marginTop: '170px' }}>
                    <p style={{ color: 'grey', marginLeft: '20px', fontSize: '13px' }}>Home / tractors</p>
                    <h3 style={{ fontWeight: '700' }}>Tractors In Pakistan</h3>
                    <hr />
                    <div className="fullForCat">
                        {this.props.cards.map((card, key) =>
                        card.category === 'Tractors'?
...
export default connect(mapStateToProps, mapDispatchToProp)(TractorsCat);